...
var _ = Describe("Ethservice", func() {
	...
	Describe("GetTransactionByHash", func() {
		...
		Context("requires a single transactionID parameter as string", func() {
		...
		Context("requires the ledger client to not return an error", func() {
			It("returns an error ", func() {
				txID := "0x1234"
				block := &common.Block{}
		...
		Context("when asking for a transaction", func() {

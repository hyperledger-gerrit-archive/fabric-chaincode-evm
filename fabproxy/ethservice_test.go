	...
	Describe("GetBlockByNumber", func() {
		...
		Context("good parameters", func() {
			...
			Context("partial transactions", func() {
				Context("returns an error when querying the ledger results in no block found", func() {
					It("block by number", func() {
						arg := make([]interface{}, 2)
						arg[0] = "0x0"
						arg[1] = false
					...
					It("block by name with no blockchain info", func() {
						arg := make([]interface{}, 2)
						arg[0] = "latest"
						arg[1] = false
					...
					It("block by name earliest", func() {
						arg := make([]interface{}, 2)
						arg[0] = "earliest"
						arg[1] = false
						mockLedgerClient.QueryInfoReturns(&fab.BlockchainInfoResponse{BCI: &common.BlockchainInfo{Height: 1}}, nil)

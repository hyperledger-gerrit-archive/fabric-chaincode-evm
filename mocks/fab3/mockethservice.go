...
type MockEthService struct {
	...
	GetLogsStub        func(*http.Request, *fab3.GetLogsArgs, *[]fab3.Log) error
	getLogsMutex       sync.RWMutex
	getLogsArgsForCall []struct {
		arg1 *http.Request
		arg2 *fab3.GetLogsArgs
		arg3 *[]fab3.Log
	}
...
func (fake *MockEthService) GetLogs(arg1 *http.Request, arg2 *fab3.GetLogsArgs, arg3 *[]fab3.Log) error {
...
func (fake *MockEthService) GetLogsCalls(stub func(*http.Request, *fab3.GetLogsArgs, *[]fab3.Log) error) {
	fake.getLogsMutex.Lock()
	defer fake.getLogsMutex.Unlock()
	fake.GetLogsStub = stub
}

func (fake *MockEthService) GetLogsArgsForCall(i int) (*http.Request, *fab3.GetLogsArgs, *[]fab3.Log) {
	fake.getLogsMutex.RLock()
	defer fake.getLogsMutex.RUnlock()

...
takes in a single object parameter similar to `eth_sendTransaction`. This
parameter, if provided, will be ignored. However, if the parameter is provided
it is expected in the object format, otherwise an error will be returned.

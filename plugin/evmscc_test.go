...
-----END CERTIFICATE-----`
		...
		Describe("Instructor smart contract with event", func() {
			var (
...
-----END CERTIFICATE-----`
				...
				runtimeCode = ""
			...
			Context("when a contract has already been deployed", func() {
				...
				It("can run the methods of the contract", func() {
					...
					res = evmscc.Invoke(stub)
					Expect(res.Status).To(Equal(int32(shim.OK)))
					setPayload := []byte{}
					n, p := stub.SetEventArgsForCall(0)
					Expect(n).To(Equal(SET))
					Expect(p).To(Equal([]byte(setPayload)))
					Expect(stub.SetEventCallCount()).To(Equal(1))

					stub.GetArgsReturns([][]byte{[]byte(contractAddress.String()), []byte(GET)})
					res = evmscc.Invoke(stub)
					Expect(res.Status).To(Equal(int32(shim.OK)))
					Expect(hex.EncodeToString(res.Payload)).To(Equal(""))
					Expect(stub.SetEventCallCount()).To(Equal(1))
				})
			})
		})

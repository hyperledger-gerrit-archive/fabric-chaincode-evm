...
- [FAB-13630](https://jira.hyperledger.org/browse/FAB-13630),
  ...
  [FAB-14021](https://jira.hyperledger.org/browse/FAB-14021) - Fab3 has limited
support for `eth_getLogs`. The method allows queries along a block range for
logs, filtering based on originating contract addresses and filtering based on
the event log topics. Subsequent releases will contain support for queries with
a blockhash.
